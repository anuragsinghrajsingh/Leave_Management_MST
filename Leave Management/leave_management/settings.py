...
SHORT_HALF_LEAVE_MIN_NOTICE_MINUTES = env.int("SHORT_HALF_LEAVE_MIN_NOTICE_MINUTES", default=15)
SHORT_HALF_LEAVE_GRACE_MINUTES = env.int("SHORT_HALF_LEAVE_GRACE_MINUTES", default=5)
SICK_LEAVE_SAME_DAY_CUTOFF_TIME = env("SICK_LEAVE_SAME_DAY_CUTOFF_TIME", default="11:59").strip()
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'App.context_processors.maintenance_mode_status',
            ],
        },
    },
]
...
LEAVE_DESK_FROM_EMAIL = env("LEAVE_DESK_FROM_EMAIL", default=DEFAULT_FROM_EMAIL)
LEAVE_RECORD_EMAILS = env("LEAVE_RECORD_EMAILS", default="")
